...
<button
    ...
    "
    class="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-2xl transition font-semibold shadow">
...
<button
    ...
    onclick="
        ...
        modal.classList.add('flex');
    "
    class="w-full bg-gray-800 hover:bg-gray-900 text-white py-3 rounded-2xl transition font-semibold shadow">
...
<div
    ...
    <div class="bg-white w-full max-w-lg rounded-3xl shadow-2xl p-8 relative">
        ...
        <form
            method="POST"
            action="{{ route('admin.perfil.password') }}"
            class="space-y-5">
